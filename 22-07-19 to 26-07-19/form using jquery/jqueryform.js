...
'<div class="newform" id="a'+x+'"><a class="display1 remove_another" id="remove' + x + '" href="/registerdog">'+
'<div class="circleBase type2"><span class="fontplus">-</span></div><p class="red2">Remove Dog</p></a>'+
