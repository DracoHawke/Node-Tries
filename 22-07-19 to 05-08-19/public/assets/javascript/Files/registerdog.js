...
$('document').ready(function(){
  ...
  $(add_button).click(function(e){ //on add input button click
    ...
    if(x < max_fields){ //max input box allowed
      ...
      '<p class="red2">Remove Dog</p></a><h3 class="fsize"> Register Your Dogs </h3>'+
      '<span class="underline2"></span></div></div><div class="card-deck cards2">'+
      '<div class="card crd1 crdleft"><div class="card-body crdpad1"><div class="display3">'+
      '<label for="file'+y+'-upload1" class="imgupload"><span class="plus" id="file'+y+'-upload1plus">+'+
      '</span><img id="file'+y+'-upload1img" class="imgpic"></img></label>'+
      ...
      '<label for="file'+y+'-upload2" class="imgupload"><span class="plus" id="file'+y+'-upload2plus">+</span>'+
      ...
      '<label for="file'+y+'-upload3" class="imgupload"><span class="plus" id="file'+y+'-upload3plus">+</span>'+
      ...
      '<label for="file'+y+'-upload4" class="imgupload"><span class="plus" id="file'+y+'-upload4plus">+</span>'+
      ...
      '<label for="file'+y+'-upload5" class="imgupload"><span class="plus" id="file'+y+'-upload5plus">+</span>'+
