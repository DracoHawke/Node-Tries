...
module.exports = function(req,res,error1){
  ...
  con.query(sql, function (err, rows, fields) {
    ...
    con.query(sql2, function(err, rows2, fields) {
      ...
      res.render('findsitter', {uname: uname, url: req.query, sid: sid, rows: allsitters, did: did, totalsitters: totalsitters, status: req.session.status, rowlen: rows.length, filters: "yes", c: c});
    });
  });
}
