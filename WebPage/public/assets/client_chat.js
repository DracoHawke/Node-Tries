...
if(data.from==to){
  ...
  if(ele!=null){
    ...
    notificationElement.innerHTML='<a href="/dashboard/chat?to='+data.from+'">Paras wants to send you a message</a>';
...
function notifyMe(user,message) {
  ...
  var notification = new Notification(user + "wants to start a chat with you ",options);
  }
...
function appendMessage(message) {
   ...
   var d=new Date();
   messageElement.innerHTML='<div class="incoming_msg_img"> <img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"> </div><div class="received_msg"><div class="received_withd_msg"><p>'+message+'</p><span class="time_date">'+d.getHours()+':'+d.getMinutes()+' | '+d.getDate()+'-'+(d.getMonth()+1)+'</span></div></div>';
