...
module.exports = function(req,res){
  ...
  con.query (sql, function (err, rows, fields) {
    ...
    con.query(sql2, function(err, rows2, fields) {
      ...
      res.render('findsitter',{uname: uname, url: req.query, sid: sid, rows: allsitters, did: did, totalsitters: totalsitters, status: req.session.status, filters: "no", c: c,login:req.session});
    });
  });
};
